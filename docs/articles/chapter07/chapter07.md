...
С помощью приложения `dictionary-parser` мы распарсили словари, но в файлах присутствуют повторяющиеся ключи.
Нужно сгруппировать записи по уникальным ключам. Для этого добавим приложение `dictionary-comb`.
