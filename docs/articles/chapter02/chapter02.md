...
сочетания иероглифов на надписи и выбрать понравившиеся сочетания. Но, конечно же, по возвращению домой нашлись
различные дела, и написание программы все откладывалось и откладывалось. Тем не менее однажды, этот
момент все-таки наступил. И я уселся за интернет изучать, что это такое - древнеегипетские иероглифы.
И очень быстро оказалось, что в этом дворе меня поджидали сплошные неприятности.
...
начала, нужно было разобраться, как описывать картинки иероглифов в символьном виде, чтобы можно
...
Далее, присутствует такой момент - иероглифы могут писаться слева направо, или справа налево, или сверху вниз.
А еще они могут группироваться, например так -
![пример группировки иероглифов #1](hiero1.png)
или так -
![пример группировки иероглифов #2](hiero2.png)
И нет общепринятого способа, как описывать такие группировки.

## Неприятность вторая или как писать иероглифы.

Несмотря на то, что иероглифы сейчас неплохо поддерживаются
[юникодом](https://symbl.cc/ru/unicode/blocks/egyptian-hieroglyphs/), у unicode-шрифтов имеются серьезные проблемы с
отображением групп иероглифов - сейчас они плохо группируются между собой,
...
бумажных книг. Но общедоступных текстовых словарей я нашел только два -
...
Плюс взял из википедии список иероглифов и классификацию по А. Гардинеру  -
